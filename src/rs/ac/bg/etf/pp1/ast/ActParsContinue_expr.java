...
public class ActParsContinue_expr extends ActParsContinue {

    private ActPars ActPars;
    private ActParsContinue ActParsContinue;

    public ActParsContinue_expr (ActPars ActPars, ActParsContinue ActParsContinue) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ActParsContinue_expr(\n");
