...
public class DesignatorStatement_method extends DesignatorStatement {

    private Designator Designator;
    private ActParsList ActParsList;

    public DesignatorStatement_method (Designator Designator, ActParsList ActParsList) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("DesignatorStatement_method(\n");
