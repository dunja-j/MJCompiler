...
public class FactorReal_method extends FactorReal {

    private Designator Designator;
    private ActParsList ActParsList;

    public FactorReal_method (Designator Designator, ActParsList ActParsList) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("FactorReal_method(\n");
