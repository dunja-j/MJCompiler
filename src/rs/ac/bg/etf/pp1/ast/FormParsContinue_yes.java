...
public class FormParsContinue_yes extends FormParsContinue {

    private FormParsDeclaration FormParsDeclaration;
    private FormParsContinue FormParsContinue;

    public FormParsContinue_yes (FormParsDeclaration FormParsDeclaration, FormParsContinue FormParsContinue) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("FormParsContinue_yes(\n");
