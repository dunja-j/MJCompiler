...
public class OneStatement_if extends OneStatement {

    private Condition Condition;
    private Statement Statement;
    private ElseStatement ElseStatement;

    public OneStatement_if (Condition Condition, Statement Statement, ElseStatement ElseStatement) {
